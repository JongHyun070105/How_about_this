        ...
        .post(
          ...
          body: jsonEncode({
            ...
            'guidelines': {
              'tone': '존댓말(해요체)',
              'rules': [
                '**절대 엄수**: 무조건 정중하고 예의 바른 존댓말(~하세요, ~이에요, ~드셨어요 등)만 사용할 것',
                '반드시 하십시오체 또는 해요체를 사용할 것 (반말 사용 시 시스템 오류 발생)',
                '사용자를 존중하는 친근하고 따뜻한 톤을 유지할 것',
                '비속어, 은어, 줄임말, 비하 표현 절대 금지',
                '음식에 대한 부정적이거나 불쾌한 표현 금지',
                '2~3문장 이내로 간결하게 작성할 것',
                '이모지는 1~2개만 적절히 사용할 것',
                '사용자의 식습관을 비판하지 말고 긍정적인 방향으로 격려할 것',
              ],
            },
          }),
        )
