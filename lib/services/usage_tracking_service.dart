...
class UsageTrackingService {
  ...
  static const String _totalRecommendationCountKey =
      'total_recommendation_count'; // New key
  static const int _maxReviewsPerDay = 5;
  static const int _maxTotalRecommendationsPerDay = 20; // Changed from 15
  ...
  Future<void> _resetCountsIfNewDay() async {
    ...
    await prefs.setInt(
      ...
      0,
    ); // Reset total recommendation count
  ...
  Future<void> forceResetAllCounts() async {
    ...
    await prefs.remove(
      _totalRecommendationCountKey,
    ); // Remove total recommendation count
  }
}
